...
export default function InfrastructureStack() {
  return (
    <section className="py-12 md:py-16 px-4 md:px-6 lg:px-8 bg-blue-100 border-y border-slate-200">
      <div className="max-w-5xl mx-auto">
        <motion.h3
          initial={{ opacity: 0, y: 10 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="text-center text-slate-900 text-xs md:text-sm uppercase tracking-wider mb-6 md:8"
        >
          Stack Backend & Infra
        </motion.h3>
